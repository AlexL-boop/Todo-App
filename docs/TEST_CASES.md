...
2) Что покрывают твои текущие тесты (coverage by design)
Текущие тесты:
...
3) Отдельно: “покрыто тестами” vs “покрыто фактически (проходит)”
...
4) Взвешенное покрытие (по приоритету/риску) — как в реальных проектах
...
5) Итоговые цифры (что можно говорить в отчёте)
...
6) Что именно “не покрыто” (и почему это важно)
...
7) Что я бы добавил, чтобы довести покрытие до “приличного”
